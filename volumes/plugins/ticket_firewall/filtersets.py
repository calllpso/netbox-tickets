...
class RuleFilterSet(NetBoxModelFilterSet):
    ...
    def search(self, queryset, name, value):
        ...
        qs_filter = Q(ticket_id__ticket_id__contains=value) | Q(protocol__name__contains=value) | Q(index__contains=value) | Q(action__contains=value) | Q(opened__icontains=value) | Q(closed__contains=value) | Q(source_prefix__contains=value) | Q(destination_prefix__contains=value)
